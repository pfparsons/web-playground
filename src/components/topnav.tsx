                ...
                <div className="ml-3 relative">
                  <div>
                    <button
                      ...
                      className="max-w-xs bg-gray-800 text-gray-100 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                      id="user-menu"
                      aria-haspopup="true"
                    >
